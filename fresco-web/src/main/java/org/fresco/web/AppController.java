...
public class AppController {
	...
	public String routeFresco(@RequestBody String vals, @RequestParam("url") String url) {
		...
		//restTemplate.exchange("http://localhost:5050/trigFresco", HttpMethod.GET, httpEntity, String.class);
	...
	public String routeQuiz(@RequestBody String vals, @RequestParam("url") String url) {
		...
		//restTemplate.exchange("http://localhost:5050/trigQuiz", HttpMethod.GET, httpEntity, String.class);
		restTemplate.exchange(url, HttpMethod.POST, httpEntity, String.class);
		return vals;
	}
}
